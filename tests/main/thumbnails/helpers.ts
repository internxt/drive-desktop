...
export async function getFileSize(buffer: Buffer): Promise<{ width: number; height: number }> {
...
export function compareImageStreams(a: string, b: string): Promise<{ isEqual: boolean; equality: number }> {
  return new Promise((resolve, reject) => {
