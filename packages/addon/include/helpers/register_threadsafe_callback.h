...
{
    std::u16string converted_resourceName(resourceName.begin(), resourceName.end());

    napi_value resourceNameValue;
    napi_create_string_utf16(env, converted_resourceName.c_str(), NAPI_AUTO_LENGTH, &resourceNameValue);
