...
describe('sync-walk', () => {
  ...
  it('should return files and folders', async () => {
    ...
    expect(results).toMatchObject([
      { path: 'C:/Users/user/InternxtDrive/file1' },
      { path: 'C:/Users/user/InternxtDrive/folder1' },
      { path: 'C:/Users/user/InternxtDrive/folder2' },
      { path: 'C:/Users/user/InternxtDrive/folder1/file2' },
    ]);
  });
});
