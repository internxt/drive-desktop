...
export function registerAuthIPCHandlers(): void {
  AuthIPCMain.handle('auth:login', async (_event: IpcMainInvokeEvent, email: string) => {
  ...
  AuthIPCMain.handle('auth:access', async (_event: IpcMainInvokeEvent, credentials: LoginAccessRequest) => {
