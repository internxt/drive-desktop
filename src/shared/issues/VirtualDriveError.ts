...
export const isVirtualDriveFileError = is<VirtualDriveFileError>(virtualDriveFileErrors);

export const isVirtualDriveFolderError = is<VirtualDriveFolderError>(virtualDriveFolderErrors);

export const isVirtualDriveError = is<VirtualDriveError>([...virtualDriveFileErrors, ...virtualDriveFolderErrors]);
