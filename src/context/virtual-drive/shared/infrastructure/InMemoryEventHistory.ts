...
export class InMemoryEventRepository implements EventRepository {
  ...
  async filter<Event extends typeof DomainEvent>(aggregateId: string, event: Event): Promise<Array<Event>> {
  ...
  async last<Event extends DomainEvent>(eventName: Event['eventName']): Promise<Optional<Event>> {
