...
export class IPCLocalFileContentsDirectoryProvider implements LocalFileContentsDirectoryProvider {
  async provide(): Promise<string> {
    const temporalFilesFolder = await ipcRenderer.invoke('APP:TEMPORAL_FILES_FOLDER');
