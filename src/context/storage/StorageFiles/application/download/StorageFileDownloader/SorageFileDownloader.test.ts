...
describe('StorageFileDownloader', () => {
  ...
  let service: StorageFileDownloader;
  ...
  beforeEach(() => {
    ...
    service = new StorageFileDownloader(managerFactory, tracker);
  ...
  describe('registerEvents', () => {
    it('should handle start download', async () => {
      await service.run(file, metadata);
  ...
  it('should successfully download a file', async () => {
    ...
    const stream = await service.run(file, metadata);
