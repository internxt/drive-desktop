...
import { ChildrenFoldersSearcher } from 'workers/sync-engine/modules/folders/application/ChildrenFoldersSearcher';
...
export interface FoldersContainer {
  ...
  childFolderSearcher: ChildrenFoldersSearcher;
}
