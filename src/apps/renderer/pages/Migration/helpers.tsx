  ...
  return (
    <svg
          ...
          <g id="e3D4vWITAh722_ts" transform="scale(1,1)">
            <g transform="translate(-197,-114.5)">
              ...
              <g id="e3D4vWITAh737_ts" transform="translate(199.499999,119.999985) scale(0.9,0.9)">
                <g id="e3D4vWITAh737" transform="translate(-311.500793,-117.715202)" opacity="0" filter="url(#e3D4vWITAh737-filter)">
                  <path
      ...
      <g transform="translate(0 0.000001)">
        <rect width="48" height="27.536766" rx="0" ry="0" transform="matrix(1 0 0 8.134579 0 0)" fill="url(#e3D4vWITAh755-fill)" />
        <rect width="48" height="27.536766" rx="0" ry="0" transform="matrix(1 0 0 8.134579 352 0)" fill="url(#e3D4vWITAh756-fill)" />
      </g>
    </svg>
  );
};
