          ...
          <Menu.Item>
            {({ active }) => (
              <div>
                <DropdownItem
                  active={active}
                  onClick={() => onScanItemsButtonClicked('files')}
                >
                  <span>
                    {translate(
          ...
          <Menu.Item>
            {({ active }) => (
              <div>
                <DropdownItem
                  active={active}
                  onClick={() => onScanItemsButtonClicked('folders')}
                >
                  <span>
                    {translate(
...
export const ChooseItemsState = ({
  ...
  return (
    <div
      ...
      data-testid="choose-items-container"
    >
      <div
      ...
      >
        <p className="font-medium text-gray-80">
          {translate('settings.antivirus.scanOptions.systemScan.text')}
        </p>
        <Button
      ...
      >
        <p className="font-medium text-gray-80">
          {translate('settings.antivirus.scanOptions.customScan.text')}
        </p>
