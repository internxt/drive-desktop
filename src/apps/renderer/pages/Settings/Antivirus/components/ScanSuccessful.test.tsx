...
describe('ScanSuccessful', () => {
  ...
  it('renders the component with correct content', () => {
    ...
    expect(mockTranslate).toHaveBeenCalledWith(
      'settings.antivirus.scanProcess.noFilesFound.title'
    );
    expect(mockTranslate).toHaveBeenCalledWith(
      'settings.antivirus.scanProcess.noFilesFound.subtitle'
    );
  });
  ...
  it('applies the correct styling', () => {
    ...
    const textContainer = screen
      .getByText('settings.antivirus.scanProcess.noFilesFound.title')
      .closest('div');
