...
export const ScanProcess = ({ currentScanPath, scannedProcess, stopScanProcess, translate }: ScanProcessProps) => (
  <div className="flex w-full flex-col items-center gap-4" data-testid="scan-process-container">
