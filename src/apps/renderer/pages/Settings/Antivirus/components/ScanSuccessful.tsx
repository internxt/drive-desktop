...
export const ScanSuccessful = ({ translate }: ScanSuccessfulProps) => (
  <div className="flex flex-col items-center gap-4" data-testid="scan-successful-container">
    <ShieldCheck size={64} className="text-green" weight="fill" data-testid="shield-check-icon" />
