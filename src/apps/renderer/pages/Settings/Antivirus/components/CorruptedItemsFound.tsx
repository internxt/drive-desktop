...
export const CorruptedItemsFound = ({
  translate,
  onRemoveMalwareButtonClicked,
}: CorruptedItemsFoundProps) => (
  <div
    className="flex flex-col items-center gap-4"
    data-testid="corrupted-items-container"
  >
    <ShieldWarning
      size={64}
      className="text-red"
    ...
    <div
      ...
      data-testid="corrupted-items-text-container"
    >
    ...
    <Button
      onClick={onRemoveMalwareButtonClicked}
