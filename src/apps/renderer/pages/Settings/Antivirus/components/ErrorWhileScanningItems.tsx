...
export const ErrorWhileScanningItems = ({ translate, onScanAgainButtonClicked }: ErrorWhileScanningItemsProps) => (
  <div className="flex flex-col items-center gap-4" data-testid="error-while-scanning-items-container">
