      ...
      <motion.div
        ...
        <div className="trasform absolute left-1/2 top-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center space-y-6 text-center">
          ...
          <div className="flex flex-col">
            <p className="text-base font-medium text-gray-100">{translate('widget.body.upToDate.title')}</p>
            <p className="text-sm text-gray-60">{translate('widget.body.upToDate.subtitle')}</p>
          </div>
        </div>
      </motion.div>
    </AnimatePresence>
