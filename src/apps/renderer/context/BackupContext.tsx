...
type BackupContext = LastBackupContextProps & BackupContextProps & BackupStatusContextProps;
...
export function BackupProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <BackupContext.Provider value={{...lastBackup, ...backupsManager, ...backupStatus}}>
      {children}
