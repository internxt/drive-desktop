...
export default function Select(props: SelectProps) {
  ...
  return (
    <RadixSelect.Root value={props.value} onValueChange={props.onValueChange} disabled={props.disabled}>
      <RadixSelect.Trigger
          ...
          <RadixSelect.Viewport className="SelectViewport">
            <RadixSelect.Group>
              {props.options.map((option) => (
                <SelectItem key={option.value} value={option.value} name={option.name} />
              ))}
            </RadixSelect.Group>
