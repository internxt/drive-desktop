...
interface StopBackupConfirmationProps extends React.ButtonHTMLAttributes<HTMLBaseElement> {
  title: string;
        ...
        <div className="min-h-screen px-4 text-center">
          ...
          <Transition.Child
            ...
            <div
              ...
              <Dialog.Title as="h3" className="text-neutral-700 text-center text-lg font-medium leading-6">
                {title}
              </Dialog.Title>
              <div className="mt-2">
                <p className="text-neutral-500/80 text-center text-sm">{children}</p>
              </div>
