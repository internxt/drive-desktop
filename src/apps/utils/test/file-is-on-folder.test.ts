...
describe('file is on folder', () => {
  const deletedfolders = ['folder', 'folder/subfolder', 'two/level/subfolder', 'windows\\subfolder'];
  ...
  it.each(filesInFoldersPaths)('file on any level should be found', (fileName: string) => {
