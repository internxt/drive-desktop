...
export default function Button({
	...
	if (variant === 'default' && !disabled) {
		...
		styles = 'bg-white text-l-neutral-40 border border-l-neutral-40 drop-shadow-sm';
		...
		styles = 'bg-l-neutral-20 active:bg-l-neutral-30 text-neutral-500 drop-shadow-sm';
	} else if (variant === 'secondary' && disabled) {
		styles = 'bg-l-neutral-20 active:bg-l-neutral-30 text-l-neutral-50 drop-shadow-sm';
	}
