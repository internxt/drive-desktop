...
function SideImageAnimation({ display, children }: { display: boolean; children: JSX.Element }) {
	return (
		<Transition
			...
			>
				{slide === 0 && (
					<div className="flex h-full grow flex-col items-center justify-center space-y-6 text-center">
						...
						<Button className="non-draggable" variant="default" onClick={() => nextSlide()}>
					...
					>
						<div className="flex flex-col items-center space-y-6">
							...
							<ul className="items-left relative flex w-full max-w-xs list-disc flex-col space-y-3 pl-4 text-base text-neutral-500">
								<li>{translate('onboarding.slides.sync-folder.description-1')}</li>

								<li>{translate('onboarding.slides.sync-folder.description-2')}</li>

								<li>{translate('onboarding.slides.sync-folder.description-3')}</li>

								<li>{translate('onboarding.slides.sync-folder.description-4')}</li>
							</ul>
						</div>
				...
				<SideTextAnimation display={slide === 2}>
					...
					>
						...
						<Button className="non-draggable" variant="default" onClick={() => finish()}>
